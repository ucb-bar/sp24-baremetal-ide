...
extern int64_t i[] __attribute__((
    aligned(4 * 4))); // [ (M+floor(F/2)) * (N+floor(F/2)) ]
extern int64_t f[] __attribute__((aligned(4 * 4)));        // [ F*F ]
extern int64_t o[] __attribute__((aligned(4 * 4)));        // [ M*N ]
extern int64_t golden_o[] __attribute__((aligned(4 * 4))); // [ M*N ]
